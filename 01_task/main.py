...
def total_salary(path):
    try:
        with open(path, "r", encoding="utf-8") as file:
            ...
            if count == 0:  
                print("Файл порожній або подані некоректні дані.")
                return 0, 0
...
total, average = total_salary("01_task/salarys_file.txt") # Файл не знайдено
total, average = total_salary("01_task/salary_file.txt") # Загальна сума заробітної плати: 6000, Середня заробітна плата: 2000
